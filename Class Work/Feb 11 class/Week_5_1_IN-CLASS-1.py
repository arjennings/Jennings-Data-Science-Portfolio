...
# there are missing values related to minors -- MNAR
...
#isnull casts a boolean mask over the dataframe -- true and false for every cell on whether it has a value or not
...
#copy og dataframe
#df clean is the imputation and deletion dataframe
df_clean = df.copy()
